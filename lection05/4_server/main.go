...
* На 1 эндпоинте нельзя хэндлить несколько методов (GET, POST, ...), можно только 1
* "/" - эндпоинт по умолчанию => нет статуса 404 => единственное решение проблемы - кастомные роутеры
*/
