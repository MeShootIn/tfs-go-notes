...
* В Go есть возможности для кооперативной и вытесняющей многозадачности
*/
...
* При завершении (но не блоке) родительской горутины сразу же завершаются и дочерние
* go someFunc()() - ТОЛЬКО СТАВИТ В ОЧЕРЕДЬ планировщика функцию и не переключается сразу на её выполнение
*/
